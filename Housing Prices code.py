...
train = pd.read_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\train.csv')
test = pd.read_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\test.csv')

#secondary dataframes
traindf = pd.DataFrame(train)
testdf = pd.DataFrame(test)
ogtestdf =pd.DataFrame(test)
...
jointest.to_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\cleanedtest.csv',index=False)
jointrain.to_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\cleanedtrain.csv',index=False)

test_df = pd.read_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\cleanedtest.csv',header=0)
train_df = pd.read_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\cleanedtrain.csv',header=0)

# *** NEED TO CORRECT MISMATCHED COLUMNS IN TRAIN AND TEST DATA SET AND FIT TO MODEL, ADD IN PRINCIPAL COMPONENT ANALYSIS/CALCULATE R SQUARE VALUES FOR PREDICTORS AND ADD XGBOOST FOR ENSEMBLE MODEL, INITIALIZE TEST VARIABLES FROM ACTUAL TEST DATA SET
...
#Exporting to csv
submission.to_csv(r'C:\Users\Tyler\Desktop\Personal Files\Kaggle\Housing Prices\housingprices_submission.csv', index=False)
